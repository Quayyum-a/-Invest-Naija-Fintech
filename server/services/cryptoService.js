...
class CryptoService {
    ...
    static getPriceAlerts(cryptoId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
    ...
    static getChangeColor(percentage) {
        if (percentage > 0)
...
CryptoService.COINGECKO_BASE_URL = "https://api.coingecko.com/api/v3";
CryptoService.API_KEY = process.env.COINGECKO_API_KEY;
