...
class InvestmentService {
        ...
        return [
            {
                ...
                description: "Low-risk investment with daily liquidity. Ideal for emergency funds and short-term savings.",
                minimumAmount: 100,
            ...
            },
            {
                ...
                description: "Government-backed securities with guaranteed returns. Perfect for capital preservation.",
                minimumAmount: 1000,
                expectedReturn: 15.2,
                riskLevel: "very_low",
                duration: "91 days",
            ...
            },
            {
                ...
                description: "Medium-term government securities with higher yields than 91-day bills.",
                minimumAmount: 1000,
                expectedReturn: 16.8,
                riskLevel: "very_low",
                duration: "182 days",
            ...
            },
            {
                ...
                description: "Short-term fixed deposit with guaranteed returns from top Nigerian banks.",
                minimumAmount: 5000,
                expectedReturn: 10.0,
                riskLevel: "very_low",
                duration: "30 days",
            ...
            },
            {
                ...
                description: "Diversified portfolio of Nigerian government and corporate bonds.",
                minimumAmount: 2500,
                expectedReturn: 14.5,
                riskLevel: "low",
                duration: "flexible",
            ...
            },
            {
                ...
                description: "Growth-focused equity fund investing in top Nigerian stocks.",
                minimumAmount: 5000,
                expectedReturn: 18.0,
                riskLevel: "medium",
                duration: "flexible",
            ...
            },
            {
                id: "dollar_fund",
                name: "Dollar Fund",
                description: "USD-denominated fund for foreign exchange diversification.",
            ...
            },
            {
                ...
                description: "Real estate-focused fund investing in Nigerian commercial properties.",
                minimumAmount: 25000,
                expectedReturn: 16.0,
                riskLevel: "medium",
                duration: "3+ years",
    ...
    static getUserPortfolio(userId) {
    ...
    static calculateInvestmentReturns(amount, rate, days) {
    ...
    static getRecommendations(userKycStatus, riskTolerance = "medium", investmentGoal = "growth") {
        ...
        if (userKycStatus !== "verified") {
            ...
            filteredProducts = products.filter((p) => p.minimumAmount <= 50000 && p.riskLevel === "low");
        }
        ...
        filteredProducts = filteredProducts.filter((p) => allowedRiskLevels.includes(p.riskLevel));
    ...
    static processInvestment(userId, productId, amount) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const products = this.getAvailableProducts();
    ...
    static getPerformanceData(userId) {
        const investments = (0, storage_1.getUserInvestments)(userId);
        ...
        const daily = Array.from({ length: 30 }, (_, i) => {
            ...
            const totalValue = investments.reduce((sum, inv) => {
                const daysHeld = Math.floor((Date.now() - new Date(inv.createdAt).getTime()) /
                    (1000 * 60 * 60 * 24));
