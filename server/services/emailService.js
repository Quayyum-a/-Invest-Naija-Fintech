...
class EmailService {
    constructor() {
        ...
        if (!process.env.GMAIL_USER || !process.env.GMAIL_APP_PASSWORD) {
            console.warn("Gmail credentials not found. Email will be logged to console.");
        }
    }
    ...
    sendTransactionNotification(userEmail, userName, transaction) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    sendKYCNotification(userEmail, userName, status, reason) {
        return __awaiter(this, void 0, void 0, function* () {
