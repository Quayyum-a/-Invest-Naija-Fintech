...
exports.getAppAnalytics = exports.getUserAnalytics = void 0;
    ...
    try {
        ...
        const analytics = {
            ...
            spending: {
                ...
                averageMonthly: monthlySpending.reduce((sum, month) => sum + month.amount, 0) /
...
const getAppAnalytics = (req, res) => {
    var _a, _b, _c, _d;
    try {
        // Only admins can access app-wide analytics
        if (!((_b = (_a = req.user) === null || _a === void 0 ? void 0 : _a.email) === null || _b === void 0 ? void 0 : _b.endsWith("@admin.com")) &&
            !((_d = (_c = req.user) === null || _c === void 0 ? void 0 : _c.email) === null || _d === void 0 ? void 0 : _d.endsWith("@investnaija.com"))) {
            return res.status(403).json({
                success: false,
                error: "Admin access required",
            });
        }
        const allUsers = (0, storage_1.getAllUsers)();
        const totalAUM = (0, storage_1.getTotalAUM)();
        const activeInvestments = (0, storage_1.getActiveInvestmentCount)();
...
exports.getAppAnalytics = getAppAnalytics;
...
function getBestPerformingInvestmentType(investments) {
    ...
    const performance = types.map((type) => {
        ...
        const totalInvested = typeInvestments.reduce((sum, inv) => sum + inv.amount, 0);
        const currentValue = typeInvestments.reduce((sum, inv) => sum + inv.currentValue, 0);
...
function calculateUserGrowth(users) {
    ...
    for (let i = months; i >= 0; i--) {
        ...
        const usersUpToDate = users.filter((user) => new Date(user.createdAt) <= date).length;
        growth.push({
