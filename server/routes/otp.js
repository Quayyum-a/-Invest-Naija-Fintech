...
exports.cleanupExpiredOTPs = exports.checkOTPStatus = exports.verifyOTP = exports.sendOTP = void 0;
...
const sendSMS = (phoneNumber, message) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (termiiApiKey) {
            const response = yield fetch("https://api.ng.termii.com/api/sms/send", {
                method: "POST",
                headers: {
            ...
            if (response.ok && result.message_id) {
                console.log(`[TERMII SMS] Successfully sent to ${phoneNumber}, ID: ${result.message_id}`);
                return true;
            }
            else {
...
const sendOTP = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (existingOTP && existingOTP.attempts >= 3) {
            const timeSinceLastAttempt = Date.now() - (existingOTP.expiresAt - 10 * 60 * 1000);
        ...
        otpStorage.set(identifier, {
            ...
            expiresAt,
            verified: false,
            attempts: ((existingOTP === null || existingOTP === void 0 ? void 0 : existingOTP.attempts) || 0) + 1,
        });
        // Send OTP
        let sent = false;
        if (phoneNumber) {
            const message = `Your InvestNaija verification code is: ${otpCode}. Valid for 10 minutes. Do not share this code.`;
            sent = yield sendSMS(phoneNumber, message);
        }
        else if (email) {
            ...
            sent = yield sendEmail(email, subject, message);
        }
        if (!sent) {
...
const checkOTPStatus = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.checkOTPStatus = checkOTPStatus;
...
setInterval(exports.cleanupExpiredOTPs, 15 * 60 * 1000);
