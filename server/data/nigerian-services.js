...
exports.serviceFees = exports.serviceCategories = exports.transferBanks = exports.billProviders = exports.nigerianNetworks = void 0;
// Nigerian Mobile Networks
exports.nigerianNetworks = [
    {
        id: "mtn",
        name: "MTN Nigeria",
        code: "MTN",
...
exports.serviceFees = {
    airtime: { fee: 0, feeType: "fixed" }, // No fee for airtime
    data: { fee: 0, feeType: "fixed" }, // No fee for data
    transfer: { fee: 10, feeType: "fixed" }, // ₦10 for bank transfers
    billPayment: { fee: 25, feeType: "fixed" }, // ₦25 for bill payments
    electricity: { fee: 50, feeType: "fixed" }, // ₦50 for electricity bills
    tv: { fee: 25, feeType: "fixed" }, // ₦25 for cable TV
    education: { fee: 100, feeType: "fixed" }, // ₦100 for education services
};
