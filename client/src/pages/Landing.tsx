        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Join thousands of Nigerians building wealth through our secure,
              user-friendly investment platform. Start with as little as ₦1,000.
            </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="card text-center">
              ...
              <p className="text-gray-600">
                Earn up to 25% annual returns on your investments
              </p>
            </div>
            ...
            <div className="card text-center">
              ...
              <p className="text-gray-600">
                Bank-level security with insurance protection
              </p>
            </div>
            ...
            <div className="card text-center">
              ...
              <p className="text-gray-600">
                Get guidance from certified investment advisors
              </p>
            </div>
      ...
      <section className="bg-primary-600 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-primary-100 mb-8">
            Join over 10,000 investors already growing their wealth with
            InvestNaija
          </p>
          <Link
            to="/register"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-400 mb-4">
              Building wealth for the next generation of Nigerian investors
            </p>
            <p className="text-gray-500">
              © 2024 InvestNaija. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
